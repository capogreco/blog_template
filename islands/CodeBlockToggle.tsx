    ...
    const addToggleButtons = () => {
      ...
      codeBlocks.forEach((pre) => {
        ...
        toggleButton.innerHTML =
          "<span style=\"font-family: 'GeistMono', monospace; font-variant-ligatures: normal;\">&lt;=&gt;</span>";
        ...
        codeElement.style.fontFamily = "'GeistMono', monospace";
        ...
        toggleButton.addEventListener("click", (e) => {
          ...
          if (ligaturesOn) {
            ...
            toggleButton.innerHTML =
              "<span style=\"font-family: 'GeistMono', monospace; font-variant-ligatures: none;\">&lt;=&gt;</span>";
          }
        });
